...
function init_melli_woocommerce()
{
    ...
    class WC_Gateway_Melli extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->deposit_id = $this->settings['deposit_id'];
        ...
        function init_form_fields()
        {
            $this->form_fields = array(
                ...
                'deposit_id' => array(
                    'title' => __('شناسه واریز', 'woocommerce'),
                    'type' => 'text',
                    'description' => __('رشته عددی 30 رقمی صادر شده از سامانه بهداد', 'woocommerce'),
                    'default' => '',
                    'desc_tip' => true
                ),
        ...
        function redirect_to_bank($order_id)
        {
            ...
            $parameters = array(
                ...
                'SignData' => $sign_data,
                'PaymentIdentity' => $this->deposit_id,
            );

            $error_flag = false;
            $error_msg = '';
            $result = $this->sadad_call_api('https://sadad.shaparak.ir/VPG/api/v0/PaymentByIdentity/PaymentRequest', $parameters);
